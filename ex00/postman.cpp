...
#define TL  "\xe2\x94\x8f" // ╭ Top-Left
#define TR  "\xe2\x94\x93" // ╓ Top-Right
#define BL  "\xe2\x94\x97" // ╗ Bottom-Left
#define BR  "\xe2\x94\x9b" // ╛ Bottom-Right
#define HH  "\xe2\x94\x81" // ━ Horizontal Heavy
#define HV  "\xe2\x94\x83" // ┃ Vertical Heavy
#define LH  "\xe2\x94\x80" // ─ Horizontal Light
#define LV  "\xe2\x94\x82" // │ Vertical Light
#define JLH "\xe2\x94\xa3" // ┣ Junction Left (T pointing right)
#define JRH "\xe2\x94\xab" // ┫ Junction Right (T pointing left)
#define JTH "\xe2\x94\xb3" // ┳ Junction Top (T pointing down)
#define JBH "\xe2\x94\xbb" // ┻ Junction Bottom (T pointing up)
#define JXH "\xe2\x95\x8b" // ╋ Junction Cross (+ shape)
#define JLl "\xe2\x94\x9c" // ├ Junction Left Light (T pointing right, light)
#define JRl "\xe2\x94\xa4" // ┤ Junction Right Light (T pointing left, light)
